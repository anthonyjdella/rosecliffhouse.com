...
(function($) {
    ...
    $(document).ready(function () {
        // Click event for lock button inside the table
        $("#lock-button").on("click", function () {
            var $passwordCell = $(this).closest("tr").find(".modal-content");
            var password = process.env.WIFI; // Replace with your actual password retrieval logic
